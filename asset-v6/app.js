...
var app = new function() {
    this.name = "Alive", this.version = "6", this.date = "2018", this.folder = "asset-v6/", this.looptime = 7111, this.bpm = 135, this.totalframe = 342, this.nbpolo = 10, this.nbloopbonus = 3, this.bonusloopA = !1, this.bonusendloopA = !1, this.recmaxloop = 26, this.recminloop = 3, this.recmintime = Math.round(this.looptime / 1e3) * this.recminloop, this.spritepolo = "polo-sprite.png", this.spritepicto = "game-picto.png", this.colBck = "#120521", this.col0 = "#a07dfa", this.col1 = "#825fd2", this.col2 = "#5f3ca0", this.col3 = "#371464", this.col4 = "#230a41", this.animearray = [{
        name: "1_kick",
        color: "1e96be",
        uniqsnd: !0
    }, {
